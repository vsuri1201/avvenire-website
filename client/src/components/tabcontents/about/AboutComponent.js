    ...
    <div class="row">
        <div class="container mar-t-50">
            <div class="about-content col-md-offset-1 col-md-11">
                <section id="about">
                    <h2 className="h2-left">What We Do?</h2>
                ...
                <section id="services">
                    <h2 className="h2-left">IT Services for Every Business Need</h2>
                ...
                <section id="industry-solutions">
                    <h2 className="h2-left">Customized Solutions for Industry-Specific Challenges</h2>
                    <p>At Avvenire Solutions, we understand that every industry faces unique challenges. That's why we specialize in delivering industry-specific solutions that address the specific needs of our clients. Whether you’re in finance, healthcare, retail, or manufacturing, we have the expertise to design solutions that meet the regulatory, operational, and technological demands of your sector. By taking the time to understand the intricacies of your business, we create solutions that not only resolve current issues but also prepare your organization for future growth and success.</p>
                </section>

                <section id="relationships">
                    <h2 className="h2-left">Building Long-Term Relationships</h2>
                    <p>Our approach is centered around building strong, lasting relationships with our clients. At Avvenire Solutions, we believe that success goes beyond just delivering a one-time solution. We aim to be a trusted partner throughout your digital transformation journey, offering ongoing support and continuous innovation. Our dedicated team works closely with you, ensuring that we’re always aligned with your evolving business goals. With an emphasis on collaboration, transparency, and integrity, we foster relationships built on trust and mutual respect, which enables us to help you navigate complex challenges and reach your full potential.</p>
                </section>

                <section id="excellence">
                    <h2 className="h2-left">Commitment to Excellence and Client Success</h2>
                ...
                <section id="location">
                    <h2 className="h2-left">Located at the Heart of a Tech Hub</h2>
